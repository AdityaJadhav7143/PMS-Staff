...
import './Home.css'
import pms from './../Pms/Pms.js'

import medicine from './medicine.png'
import pmsimg from './pmsimg.jpg'
        ...
        <div>
          <div class="wrapper">
            <div class="row" id="header">
              <div class="col-md-7">
                <h3><b>Pharmacy  Staff  Management  System</b></h3>
              </div>
...
<div class="carousel-inner">
      <div class="carousel-item active">
        <img src={medicine} class="d-block w-100 p-0" alt="..." height="600px"/>
        <div class="carousel-caption d-none d-md-block">
          <h2><b>Welcome To Our Site</b></h2>
          <Link to="Pms "> <button class="btn btn-primary">PMS Info</button></Link>
          <Link to="Tech"><button class="btn btn-success ms-1 ">TECH</button></Link>
        </div>
      </div>
    </div>
